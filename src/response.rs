...
>(
    ...
    let Some(value) = headers.get(crate::X_SUCCESS_HEADER) else { return Ok(None); };
    ...
    if value.eq_ignore_ascii_case("true") {
        ...
        Err(crate::ClientError::invalid_response(NatsErrorResponse::internal(
            "INVALID_RESPONSE",
    ...
    match ::serde_json::from_slice(payload) {
        ...
        Err(error) => {
            if let Some(response) = crate::error::try_deserialize_error_response(payload) {
                ...
                Err(crate::ClientError::deserialize(crate::NatsErrorResponse::internal(
                    "DESERIALIZATION_ERROR",
                    error.to_string(),
                )))
            }
...
>(
    ...
    match response_success_from_headers::<E>(headers)? {
        Some(true) => {
            ...
            return Err(crate::ClientError::invalid_response(NatsErrorResponse::internal(
                "INVALID_RESPONSE",
    ...
    Err(crate::ClientError::invalid_response(crate::NatsErrorResponse::internal(
        "DESERIALIZATION_ERROR",
    ...
    match eph_ctx.decrypt_response(payload) {
        ...
        Err(error) => {
            if let Some(response) = crate::error::try_deserialize_error_response(payload) {
                ...
                Err(crate::ClientError::decrypt(crate::NatsErrorResponse::internal(
                    "DECRYPT_ERROR",
                    error.to_string(),
                )))
            }
